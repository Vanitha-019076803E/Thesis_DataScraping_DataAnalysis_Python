...
with open('/home/vanitha/Mining_pastebin/Supervised/Large_data/Text_data_filtered.csv', 'r') as text_data_file:
...
r  = int((len(pastes)+ len(text_data[:12001]))/4)
i = 0
print(r)
...
while i < r:
    ...
    append_row('/home/vanitha/Mining_pastebin/Supervised/Large_data/Dataset_labeled.csv', row_contents)
    row_contents = ['text only',text_data[i]]
    append_row('/home/vanitha/Mining_pastebin/Supervised/Large_data/Dataset_labeled.csv', row_contents)
    i = i+1
...
while p < s:
    ...
    row_contents = ['code and text',pastes[p]+text_data[p]]
    append_row('/home/vanitha/Mining_pastebin/Supervised/Large_data/Dataset_labeled.csv', row_contents)
    p = p+1
...
while  q < len(pastes):
    #final_data.append(['code and text',pastes[p]+text_data[p]])
    row_contents = ['code and text',text_data[q]+pastes[q]]
    append_row('/home/vanitha/Mining_pastebin/Supervised/Large_data/Dataset_labeled.csv', row_contents)
    q = q+1
